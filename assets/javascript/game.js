...
$("#play").click(function(){
    ...
    if (isTouchScreen === true) {
        $(".keyboard").append('<div style="overflow: hidden; position: relative; width: 1px; height: 1px; left: -500px"><input id="keyboard-button" type="textfield" autocorrect="off" autocapitalize="off"></div><input type="button" value=" " onclick="document.getElementById(\'keyboard-button\').focus();">');
        $(".keyboard").show();
    }
}) 
